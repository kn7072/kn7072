...
KC_ESC, KC_TAB,  A_LGUI, S_LALT, D_LSFT, F_LCTL, KC_G,                                            KC_H, J_RCTL, K_RSFT, L_LALT, SCLN_RGUI, KC_QUOT, KC_CAPS_LOCK, 
        KC_LCTL, KC_Z,   KC_X,   KC_C,   KC_V,   KC_B, QK_LEADER, KC_HOME,   KC_END, KC_BSLS, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RBRC, 
        KC_LWIN, MY_BUTTON, KC_SPC, LOWER, KC_DELETE,                                        KC_BACKSPACE, RAISE, KC_ENT, TG(_UNICODE), KC_PSCR),
...
_______, _______, KC_APP_LGUI, BSLS_LALT,    HOME_LSFT,    END_LCTL, KC_LPRN,                                       KC_LEFT, DOWN_RCTL, UP_RSFT, RIGHT_LALT, MINS_RGUI, KC_EQL, KC_CAPS_LOCK,
         _______, KC_PGDN, KC_PGUP,   KC_BACKSPACE, KC_DELETE,      KC_RPRN, _______, _______,    _______, KC_PSCR, KC_LBRC, KC_RBRC, KC_COMM, KC_DOT, KC_SLSH, _______, 
         _______, _______, _______, _______, _______,                                                                _______, _______, _______, _______, _______),

  [_RAISE] = LAYOUT(
         KC_F12,  KC_F1,     KC_F2,    KC_F3,    KC_F4,   KC_F5,                                             KC_F6,     KC_F7,     KC_F8,    KC_F9,   KC_F10,   KC_F11, 
         _______, KC_EXLM,   KC_AT,    KC_HASH,  KC_DLR,  KC_PERC,                                           KC_CIRC,   KC_AMPR,   KC_ASTR,  KC_LPRN, KC_RPRN,  _______, 
_______, _______, KC_MPRV,   KC_MNXT,  KC_VOLU,  KC_PGUP, KC_MINS,                                           KC_PLUS,   KC_HOME,   _______,  _______, _______, KC_BSLS, _______,
         KC_MUTE, KC_MSTP,   KC_MPLY,  KC_VOLD,  KC_PGDN, KC_UNDS, _______, _______,       _______, _______, KC_EQL,    KC_END,    _______,   _______, _______, _______,
         _______, _______,   _______,  _______,  _______,                                                                   _______, _______, _______, _______, _______),
  ...
  [_ADJUST] = LAYOUT(
      ...
      RGB_VAD, _______, _______, _______, _______, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, _______, _______, _______,
  ...
  [_UNICODE] = LAYOUT(
      ...
      _______, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, _______, KC_NO, KC_NO, KC_NO, KC_NO,
      KC_NO, KC_NO, _______, _______, _______, _______, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, _______, _______,
