...
enum custom_keycodes { QWERTY = SAFE_RANGE, LOWER, RAISE, ADJUST, MY_BUTTON };
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
        ...
        /* } */
        // case KC_ ... KC_L: {//
        // https://docs.qmk.fm/#/ChangeLog/20231126?id=switch-statement-helpers-for-keycode-ranges
...
const uint16_t PROGMEM test_combo2[] = {KC_N, KC_M, COMBO_END};
const uint16_t PROGMEM test_combo3[] = {KC_Q, KC_W, COMBO_END};
combo_t key_combos[] = {
    COMBO(test_combo1, KC_QUESTION),  // UM(SPEAKER_TG)
    COMBO(test_combo2, KC_KP_COMMA),  // LCTL(KC_Z) keycodes with modifiers are possible too!
    COMBO(test_combo3, KC_AMPERSAND),
};
