...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT(
             _______,   _______,      _______,    KC_MUTE,       KC_MEDIA_STOP, Q_LCTL,                                                   KC_LEFT,    KC_DOWN,    KC_UP,    KC_RIGHT,    KC_MPLY,  _______,
             _______,   KC_1,         KC_2,       KC_3,          KC_4,          KC_5,                                                     KC_6,       KC_7,       KC_8,     KC_9,        KC_0,     KC_LBRC,
   _______,  _______,   KC_APP_LGUI,  BSLS_LALT,  HOME_LSFT,     END_LCTL,      KC_LPRN,                                                  KC_LEFT,    DOWN_RCTL,  UP_RSFT,  RIGHT_LALT,  KC_MINS,  KC_EQL,    KC_CAPS_LOCK,
