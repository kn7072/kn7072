...
driver = WebDriver('http://10.76.121.165:4444/wd/hub', webdriver.DesiredCapabilities.CHROME)
driver.execute('get', {'url': 'http://www.chromium.org/developers/deep-memory-profiler'})  # Command.GET
driver.session_id
r = requests.get('http://10.76.121.165:4444/wd/hub/session/'+str(driver.session_id)+'/url')
r.json()
r2 = requests.get('http://10.76.121.165:4444/wd/hub/session/'+str(driver.session_id)+'/window_handles')
#'http://10.76.121.165:4444/wd/hub/session/62073d57-e674-4efb-ad8c-8b02325475b3/url'
r3 = requests.post('http://10.76.121.165:4444/wd/hub/session/'+str(driver.session_id)+'/frame')
headers = {'Accept', 'application/json'}
r7 = requests.post('http://10.76.121.165:4444/wd/hub/session/'+str(driver.session_id)+'/chrome/heapprofilerdump', headers=headers)
r3.json()
