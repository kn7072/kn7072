...
скопировать файлы из текущего каталога (каталог_1) в каталог_2
причем структура каталога_1 будет воспроизведена в каталоге_2
cd /полный/путь/к/каталог_1
find . -type f -exec cp --parents {} /home/stepan/каталог_2/ \;
