...
|                              |                                                                        |
| ---------------------------- | ---------------------------------------------------------------------- |
| 1<br><br>2<br><br>3<br><br>4 | `ip address show`<br><br>`ip addr show`<br><br>`ip addr`<br><br>`ip a` |

[![[1635a48a1188a4d46c29e325ce778a24_MD5.png]]](https://zalinux.ru/wp-content/uploads/2020/04/ip-a.png)
...
[![[198710c1beed7c1e01eef44431d9dfa9_MD5.png]]](https://zalinux.ru/wp-content/uploads/2020/04/ip-4-a.png)
...
[![[97c964122538a187e1e98cc1dc3f581f_MD5.png]]](https://zalinux.ru/wp-content/uploads/2020/04/ip-6-a.png)
...
|            |                                                |
| ---------- | ---------------------------------------------- |
| 1<br><br>2 | `ip a show dev lo`<br><br>`ip a show dev wlo1` |

[![[3643c48dd7ff158cf40ccfdbb09f2b87_MD5.png]]](https://zalinux.ru/wp-content/uploads/2020/04/ip-a-show-wlo1.png)

Можно пропустить строку **dev**:

|            |                                        |
| ---------- | -------------------------------------- |
| 1<br><br>2 | `ip a show lo`<br><br>`ip a show wlo1` |

[![[461d64ce72c8fffb9b8c64fdfd812aaa_MD5.png]]](https://zalinux.ru/wp-content/uploads/2020/04/ip-command-examples.png)
...
|     |                                                |
| --- | ---------------------------------------------- |
| 1   | `sudo` `ip a add 192.168.0.33``/24` `dev wlo1` |
...
[![[fc737a81ff27e82c6564ac3b16df55f2_MD5.png]]](https://zalinux.ru/wp-content/uploads/2020/04/ip-a-add.png)
...
[![[d96806f797f8a27cd8457ed301f00f2c_MD5.png]]](https://zalinux.ru/wp-content/uploads/2020/04/ping.png)
...
|     |                                                |
| --- | ---------------------------------------------- |
| 1   | `sudo` `ip a del 192.168.0.33``/24` `dev wlo1` |
...
[![[6bdc4fc95cc445572c64cad722b3f3e9_MD5.png]]](https://zalinux.ru/wp-content/uploads/2020/04/ip-statistics.png)
...
[![[bd7e086a8abd13c96e4700704eb4c662_MD5.png]]](https://zalinux.ru/wp-content/uploads/2020/04/ip-link-show.png)
...
[![[68eae4637a55a5a65ea272d68630d691_MD5.png]]](https://zalinux.ru/wp-content/uploads/2020/04/ip-link-set.png)
...
[![[314909d66b58146122fe19dbf3ad44a2_MD5.png]]](https://zalinux.ru/wp-content/uploads/2020/04/ip-route.png)
...
|     |                                                          |
| --- | -------------------------------------------------------- |
| 1   | `default via 192.168.0.1 dev wlo1 proto dhcp metric 600` |
...
|     |                                                                               |
| --- | ----------------------------------------------------------------------------- |
| 1   | `192.168.0.0/24 dev wlo1 proto kernel scope link src 192.168.0.89 metric 600` |
...
|     |                                  |
| --- | -------------------------------- |
| 1   | `ip route list 192.168.0.0``/24` |
...
|                                                         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1<br><br>2<br><br>3<br><br>4<br><br>5<br><br>6<br><br>7 | `default via 10.8.0.1 dev tun0 proto static metric 50`<br><br>`default via 192.168.0.1 dev wlo1 proto dhcp metric 600`<br><br>`10.8.0.1 dev tun0 proto kernel scope link src 10.8.0.10 metric 50`<br><br>`10.8.0.1 via 10.8.0.1 dev tun0 proto static metric 50`<br><br>`185.117.153.79 via 192.168.0.1 dev wlo1 proto static metric 600`<br><br>`192.168.0.0/24 dev wlo1 proto kernel scope link src 192.168.0.89 metric 600`<br><br>`192.168.0.1 dev wlo1 proto static scope link metric 600` |
...
|     |                                                                          |
| --- | ------------------------------------------------------------------------ |
| 1   | `sudo` `ip route add 157.245.118.66 via 192.168.0.1 dev wlo1 metric 100` |
...
|     |                                                      |
| --- | ---------------------------------------------------- |
| 1   | `sudo` `ip addr add 192.168.121.1``/24` `dev enp0s8` |
...
|     |                                                             |
| --- | ----------------------------------------------------------- |
| 1   | `sudo` `ip route delete default via 192.168.4.1 dev enp0s8` |
...
|     |                                                                  |
| --- | ---------------------------------------------------------------- |
| 1   | `sudo` `ip route add 192.168.121.0``/24` `dev enp0s8 metric 100` |
...
|     |                                                        |
| --- | ------------------------------------------------------ |
| 1   | `sudo` `ip route delete 192.168.4.0``/24` `dev enp0s8` |
