...
name_groups = ["Причастие - сложное дополнение с причастием 1(после глаголов)", "Причастие", "Сложное дополнение с причастием 1"]
path_to_words = r"НеличныеФормы\Причастие\СложноеДополнениеПрич_1\слова.txt"
