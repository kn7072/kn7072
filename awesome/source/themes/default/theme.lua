...
theme.font = "liberation 10" -- "sans 8"  fc-list | grep "liber"

theme.bg_normal = "#222222" -- тэги не в фокусе
theme.bg_focus = "#1e4e8a" -- "#535d6c"
...
local taglist_square_size = dpi(6) -- квадрат активного окна
...
theme.menu_width = dpi(150) -- You can add as many variables as
...
-- theme.wallpaper = "/home/stepan/.config/awesome/themes/default/images/Cape.jpg" -- Fishing.jpeg"
theme.wallpaper = themes_path .. "default/images/Fishing.jpeg"
-- theme.wallpaper = themes_path .. "default/images/Cape.jpg"
...
--
-- user icons
theme.terminal_icon = "/usr/share/icons/hicolor/128x128/apps/fire.png"
theme.firefox_icon =
    "/home/stepan/icons/icons/VCollection5/v_collection_png/128x128/plain/bomb.png"
