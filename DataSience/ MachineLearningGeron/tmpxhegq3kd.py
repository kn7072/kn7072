    ...
    def create_converted_entity(ag__, ag_source_map__, ag_module__):
        ...
        def tf__test_function(iterator):
            ...
            with ag__.FunctionScope('test_function', 'fscope', ag__.ConversionOptions(recursive=True, user_requested=True, optional_features=(), internal_convert_user_code=True)) as fscope:
                ...
                outputs = ag__.converted_call(self.distribute_strategy.run, (self.test_step,), dict(args=(data,)), fscope)
        ...
        tf__test_function.ag_source_map = ag_source_map__
        tf__test_function.ag_module = ag_module__
        tf__test_function = ag__.autograph_artifact(tf__test_function)
