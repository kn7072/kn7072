...
driver = WebDriver('http://192.168.1.3:4444/wd/hub', desired_capabilities=caps)
driver.refresh()
driver.execute('get', {'url': 'http://www.chromium.org/developers/deep-memory-profiler'})  # Command.GET
driver.session_id
r = requests.get('http://192.168.1.3:4444/wd/hub/session/'+str(driver.session_id)+'/url')
r.json()
r2 = requests.get('http://192.168.1.3:4444/wd/hub/session/'+str(driver.session_id)+'/window_handles')
#'http://10.76.121.165:4444/wd/hub/session/62073d57-e674-4efb-ad8c-8b02325475b3/url'
headers = {'Accept': 'application/json','Content-Type':'application/json;charset=UTF-8'}
r3 = requests.post('http://192.168.1.3:4444/wd/hub/session/'+str(driver.session_id)+'/refresh', headers=headers, data=driver.session_id.encode('utf-8'))  # /framep ost
r4 = requests.get('http://192.168.1.3:4444/wd/hub/session/'+str(driver.session_id)+'/orientation')
r3.json()
driver.get_installed_extensions()
print()