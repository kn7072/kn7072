...
server.start()
resp = request_1.post('http://localhost:9090/proxy', {})
resp
resp.content
...
resp = request_1.put('http://localhost:9090/proxy/9091/har', {"initialPageRef": "google"})
...
resp = request_1.get('http://localhost:9090/proxy/9091/har')
resp.content
s = resp.json()
print('s')